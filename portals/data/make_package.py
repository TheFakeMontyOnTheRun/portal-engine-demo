...
def palettize_file( filename ):
    ...
    output_filename = filename.replace( os.path.splitext(filename)[1], ".img").replace("src/", "res/")
    ...
    img_dst.write(bytearray([(img_src.width & 0xFF00) >> 8, img_src.width & 0xFF, (img_src.height & 0xFF00) >> 8, (img_src.height & 0xFF)]))
